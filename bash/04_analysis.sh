...
psql $BUILD_ENGINE -f $(pwd)/analysis/projects_dollars_mapped_categorized_managing.sql
psql $BUILD_ENGINE -f $(pwd)/analysis/projects_dollars_mapped_categorized_sponsor.sql

# Planned commitments by community district
echo 'Creating reports by community district'
psql $BUILD_ENGINE -f $(pwd)/analysis/projects_by_communitydist.sql
psql $BUILD_ENGINE -f $(pwd)/analysis/projects_by_communitydist_spending.sql
psql $BUILD_ENGINE -f $(pwd)/analysis/projects_by_communitydist_spending_date.sql

# # Agency validated geoms summary table
echo 'Creating agency validated geoms summary table'
psql $BUILD_ENGINE -f $(pwd)/analysis/agency_validated_geoms_summary_table.sql
