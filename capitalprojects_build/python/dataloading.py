...
if __name__ == "__main__":
    ...
    LOAD(
        "https://raw.githubusercontent.com/NYCPlanning/db-cpdb/master/capitalprojects_build/data/dcp_projecttypes_agencies.csv",
        "dcp_projecttypes_agencies",
    )
    LOAD(
        "https://raw.githubusercontent.com/NYCPlanning/db-cpdb/master/capitalprojects_build/data/agencylookup.csv",
        "dcp_agencylookup",
    )
    LOAD(
        "https://raw.githubusercontent.com/NYCPlanning/db-cpdb/master/capitalprojects_build/data/dcp_json.csv",
        "dcp_json",
    )
    LOAD(
        "https://raw.githubusercontent.com/NYCPlanning/db-cpdb/master/capitalprojects_build/data/cpdb_geomsremove.csv",
        "cpdb_badgeoms",
    )
    LOAD(
        "https://raw.githubusercontent.com/NYCPlanning/db-cpdb/master/capitalprojects_build/data/id_bin_map.csv",
        "dcp_id_bin_map",
    )
