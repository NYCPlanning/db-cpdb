...
# makes selection
parkproj = pd.read_sql_query('SELECT * FROM dpr_capitalprojects WHERE park_id is not NULL', engine)
...
parkproj_cleaned.to_sql('dpr_capitalprojects_fms_parkid',engine, if_exists='replace', index=False)
